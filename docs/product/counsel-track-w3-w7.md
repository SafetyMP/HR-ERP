...
| 4 | Product | Feature brief **028** (partner filing UX + counsel package) PO-approved | UAC for HR ops demo |
...
| 4 | Engineering | COBRA notice PDF (Feature **027** after gate 3) | Counsel-reviewed template only |
...
- `w3_counsel_signoff_date`
- `w7_cobra_notice_state` (`workflow_only` | `pdf_pilot` | `production`)
