...
export default async function OrganizationPage(props: Props) {
  ...
  return (
    <div className="mx-auto flex min-h-[60vh] w-full max-w-3xl flex-col gap-8 px-6 py-12">
      <header>
        <p className="text-sm font-semibold uppercase tracking-[0.2em] text-muted-foreground">Directory</p>
        <h1 className="mt-2 text-3xl font-semibold text-foreground">Who&apos;s around me</h1>
