-- Payroll bounded context — transactional outbox (same DB as payroll aggregates).
...
COMMENT ON TABLE domain_outbox IS 'Transactional outbox for payroll; publisher sets claimed_at then published_at.';
